...
export const PostsComponent: FC<PostsProps> = props => {
    const {posts, getPost, setCurrentPost, post, history, setPostLoading, postsLoading} = props;
    ...
    }, [posts, history.location.pathname, getPost, setCurrentPost, setPostLoading])
                ...
                {!postsLoading && post &&
                    <>
                        ...
                        <div className='content'>
                            ...
                            <br/>
                            <div className='has-text-weight-bold section-title'>Posted:</div>
                            <p className='is-size-8'>{new Date(post.creationDate).toString()}</p>
